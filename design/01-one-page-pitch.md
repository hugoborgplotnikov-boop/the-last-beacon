...
> **Playtest note (2026-08-01):** the fuel/light mechanic was cut after the first playtest ("too dark, not fun"), and the lantern + embers were removed entirely on a second pass — the keeper's weapon is now **the greatsword**. The game is a straight souls-like. Title, setting, and descent unchanged.
...
2. **Fight** with the keeper's greatsword: methodical stamina combat with i-frame dodges
3. **Descend** — every layer is a question answered by going deeper: *who let the light die?*
4. **Die, lose your progress, recover it at your corpse** — the souls loop
...
- **The previous keepers** — ghostly NPCs whose failed descents teach you the world (and the lore)
- **The drowned** — each boss is a story: the Captain, the Drowned Choir, the Leviathan beneath all
- **The logbook** — item descriptions and entries carry the history; no cutscenes
- **The question under it all:** why does the sea want the light out?

## Scope Budget (guardrails)

- One island, one vertical descent — 3 major regions (caves / drowned city / the deep)
- 6–8 bosses, minimal cutscenes, story via items + NPCs
- Placeholder art for prototype; final pixel style at vertical slice
- **Timeline: 12–24 months.** Milestone 1: one boss that feels *great*
...
| Item | Cost |
|---|---|
| Godot 4, Krita, Git/GitHub, itch.io | Free |
