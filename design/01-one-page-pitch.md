...
> **Playtest note (2026-08-01):** the fuel/light mechanic was cut after the first playtest ("too dark, not fun"), and the lantern + embers were removed entirely on a second pass — the keeper's weapon is now **the anchor**. The game is a straight souls-like. Title, setting, and descent unchanged.
...
2. **Fight** with the keeper's anchor: methodical stamina combat with i-frame dodges
